...
class PlantCreatingByEloquentTest extends TestCase
{
    ...
    protected PlantsRequirementsRepository $requirementsRepository;

    protected function setUp(): void
    {
        parent::setUp();

        $this->plantRepository = app(PlantRepository::class);
        $this->requirementsRepository = app(PlantsRequirementsRepository::class);
    ...
    {
        $createdPlant = Plant::create($this->plantArray);
        $plantFromRepository = $this->plantRepository->getPlantById($createdPlant->id);
        $this->assertEquals($plantFromRepository->id, $createdPlant->id);
    }
    ...
    public function test_create_plant_and_requirement()
    {
        ...
        $createdPlant->requiements()->create();
        $requirements = $this->requirementsRepository->getRequirementsByPlantId($createdPlant->id);

        $this->assertEquals($createdPlant->id, $requirements->plant_id);
    }
    ...
    public function test_create_plant_and_watering_requirement()
    {
        ...
        $requirements = $createdPlant->requiements()->create();
    ...
    public function test_create_plant_and_repotting_requirement()
    {
        ...
        $specialRepottingRequirements = SpecialRepottingRequirement::create(['name'=>'test', 'description'=>'test']);
